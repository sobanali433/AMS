...
var areachartSalesColors = getChartColorsArray("branch_qualified_leads_summary");
if (areachartSalesColors) {
    //$.ajax({
    //    type: "GET",
    //    url: UrlContent("Dashboard/GetBranchMedbQualifiedLeads?date=1 jan,2024-31 jan,2024"),
    ...
    //                },
    //                title: {
    //                    text: 'Total Branch MedB Qualified',
    //                    offsetX: 0,
    //                    offsetY: -30,
    //                    style: {
    //                        color: '#78909C',
    ...
    //        };
    //        var chart = new ApexCharts(document.querySelector("#branch_qualified_leads_summary"), options);
    //        chart.render();
    //    }
    //});
}
