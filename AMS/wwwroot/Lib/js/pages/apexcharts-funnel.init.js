...
var pyramidChartColors = getChartColorsArray("qualityof_lead_chart");
if (pyramidChartColors) {
    //$.ajax({
    //    type: "GET",
    //    url: UrlContent("Dashboard/GetQualityOfLeadScaleSummary?date=1 jan,2024-31 jan,2024"),
    ...
    //        var chart = new ApexCharts(document.querySelector("#qualityof_lead_chart"), options);
    //        chart.render();
    //    }
    //});
}