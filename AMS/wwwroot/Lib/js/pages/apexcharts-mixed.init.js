...
// Line & Area Charts
var chartLineAreaColors = getChartColorsArray("branch_summary_area_chart");
if (chartLineAreaColors) {
    //$.ajax({
    //    type: "GET",
    //    url: UrlContent("Dashboard/GetBranchSummary?date=1 jan,2024-31 jan,2024"),
    ...
    //        };
    //        var chart = new ApexCharts(document.querySelector("#branch_summary_area_chart"), options);
    //        chart.render();
    //    }
    //});
}
