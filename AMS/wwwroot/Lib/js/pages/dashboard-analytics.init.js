...
// Countries charts
var barchartCountriesColors = getChartColorsArray("states_charts");
if (barchartCountriesColors) {
    //$.ajax({
    //    type: "GET",
    //    url: UrlContent("Dashboard/GetLeadStateSummary?date=1 jan,2024-31 jan,2024"),
    ...
    //        var chart = new ApexCharts(document.querySelector("#states_charts"), options);
    //        chart.render();
