...
(function () {
	...
	var horizontalMenuSplit = 15; // after this number all horizontal menus will be moved in More menu options
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/french.svg";
			} else if (lang == "ar") {
				document.getElementById("header-lang-img").src = "Lib/images/flags/ae.svg";
			}
	...
	function getLanguage() {
		...
		request.open("GET", "Lib/lang/" + language + ".json");
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="Lib/images/logo-sm.png" alt="" height="22"></a>';
		...
		if (searchInput) {
			...
			searchInput.addEventListener("keyup", function (event) {
				...
				if (inputLength > 0) {
					...
					$.ajax({
						type: "POST",
						url: UrlContent("Lead/SearchLead"),
						data: {
							search: inputVal
						},
						success: function (result) {
							...
							$.each(result.data, function (i, row) {
								html += `<a href="` + (UrlContent("Lead/Details?id=") + row.encId + "&view=" + true) + `" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="/lib/images/users/user-dummy-img.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="m-0">`+ row.patientFullName + `</h6>
                                            <span class="fs-11 mb-0 text-muted">#`+ row.leadNo + `</span>
                                        </div>
                                    </div>
                                </a>`;
							});
							$("#divLeads").html(html);
							/*<i data-feather="arrow-right-circle" class="align-middle me-3 rounded-circle fs-18 text-muted me-2"></i>*/
							feather.replace();
						}
					})
					...
					if (elem.querySelectorAll(".notification-item").length > 0) {
						...
						if (!emptyNotificationElem) {
							...
							<div class="w-25 w-sm-50 pt-3 mx-auto">\
								<img src="Lib/images/svg/bell.svg" class="img-fluid" alt="user-pic">\
							</div>\
